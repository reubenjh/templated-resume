...
<body>
	...
	<!-- Header-->
	<header>
		<h1>Reuben Harcourt</h1>
		<p>Senior Potato Farmer & Bum Flasher</p>
	</header>
	...
	<div class="container">
		...
		<section class="education">	
			<h2>B.A. Philosophy & Criminology </br> Victoria University of Wullington.</h2>
		</section>
		...
		<section class="experience">
			<div class="row">
				<div class="grid-2">
					<h2>Head of Digital – One Percent Collective</h2>
					<p>July. 2015 - March. 2017</p>
				</div>
				<div class="grid-4">
					<ul>
						<li>Did some stuff</li>
						<li>There for ages</li>
						<li>Played duck duck goose one too many times and accidentally swallowed a fly</li>
					</ul>
				</div>
			</div>
			<div class="row">
